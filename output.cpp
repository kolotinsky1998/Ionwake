...
void output::StartOutput() {
    ...
    cout << "Physical delta t  : " << Kinetic->GetDeltaT() * Converter->GetRd() / Converter->GetThermalVelocity() << "s"
         << endl;
    cout << endl;
    ...
    cout << "                        X       Y       Z     " << endl;
    cout << endl;
    cout << "coordinate step  " << "\t" << Converter->GetCoordinateStepX() << "\t" << Converter->GetCoordinateStepY()
         << "\t" << Converter->GetCoordinateStepZ() << endl;
    cout << "velocity step    " << "\t" << Kinetic->Gethvx() << "\t" << Kinetic->Gethvy() << "\t" << Kinetic->Gethvz()
         << endl;
    cout << "coordinate N     " << "\t" << Converter->GetNx() << "\t" << Converter->GetNy() << "\t"
         << Converter->GetNz() << endl;
    cout << "velocity N       " << "\t" << Kinetic->GetNvx() << "\t" << Kinetic->GetNvy() << "\t" << Kinetic->GetNvz()
         << endl;
    cout << "cut velocity     " << "\t" << Kinetic->GetCutVelocityAlong() << "\t" << Kinetic->GetCutVelocityNormal()
         << "\t" << Kinetic->GetCutVelocityNormal() << endl;
    cout << "length of the box" << "\t" << Converter->GetCoordinateStepX() * Converter->GetNx() << "\t"
         << Converter->GetCoordinateStepY() * Converter->GetNy() << "\t"
         << Converter->GetCoordinateStepZ() * Converter->GetNz() << endl;
    cout << "#########################################################" << endl;
    cout << endl;
