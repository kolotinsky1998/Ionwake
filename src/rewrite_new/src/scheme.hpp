...
class Scheme{
    ...
    private:
        ...
        double ******f; ///distribution function of ions
        double ******ftime; ///helping distribution function
        double ***n; ///ions' concentration
        double ***fi; ///potential
        double ***ax, ***ay, ***az; ///accelaration of ions

        ///Helping variables
        double ***maxvell; ///save Maxwellian lattice function
