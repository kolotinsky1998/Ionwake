...
class Scheme{
    ...
    private:
        Converter converter;
        /// Coordinate space
        int nx, ny, nz; ///amount of cells in coordinate space
        ...
        MDArray6<double> f; ///distribution function of ions
        MDArray6<double> ftime; ///helping distribution function
        MDArray3<double> n; ///ions' concentration
        MDArray3<double> fi; ///potential
        MDArray3<double> ax, ay, az; ///accelaration of ions

        ///Helping variables
        MDArray3<double> maxvell; ///save Maxwellian lattice function
