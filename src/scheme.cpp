...
//using namespace std;
//
//Scheme::Scheme(Converter converter_, std::size_t nx_, size_t ny_, size_t nz_,
...
//        f(TArray<double, 6>({nx_, ny_, nz_, 5, 5, 5})) {
...
//                                                      vx[a] * (ftime(i, j, k, a, b, c) - ftime(i - 1, j, k, a, b, c)) *
//                                                      dt / hx;
//                            }
//                        }
//                    } else {
...
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                f(i, j, k, a, b, c) = ftime(i, j, k, a, b, c) -
//                                                      vx[a] * (ftime(i + 1, j, k, a, b, c) - ftime(i, j, k, a, b, c)) *
//                                                      dt / hx;
//                            }
//                        }
//                    }
...
//                                                          vy[b] * (f(i, j, k, a, b, c) - f(i, j - 1, k, a, b, c)) * dt /
//                                                          hy;
//                            }
//                        } else {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                ftime(i, j, k, a, b, c) = f(i, j, k, a, b, c) -
//                                                          vy[b] * (f(i, j + 1, k, a, b, c) - f(i, j, k, a, b, c)) * dt /
//                                                          hy;
//                            }
//                        }
//                    }
...
//                            if (vz[c] > 0) {
//                                f(i, j, k, a, b, c) = ftime(i, j, k, a, b, c) -
//                                                      vz[c] * (ftime(i, j, k, a, b, c) - ftime(i, j, k - 1, a, b, c)) *
//                                                      dt / hz;
//                            } else {
//                                f(i, j, k, a, b, c) = ftime(i, j, k, a, b, c) -
//                                                      vz[c] * (ftime(i, j, k + 1, a, b, c) - ftime(i, j, k, a, b, c)) *
//                                                      dt / hz;
//                            }
//                        }
//                    }
...
//                        for (size_t b = 1; b < nvy - 1; b++) {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                ftime(i, j, k, a, b, c) = f(i, j, k, a, b, c) - ax(i, j, k) * (f(i, j, k, a, b, c) -
//                                                                                               f(i, j, k, a - 1, b,
//                                                                                                 c)) * dt / hvx;
//                            }
//                        }
...
//                        for (size_t b = 1; b < nvy - 1; b++) {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                ftime(i, j, k, a, b, c) = f(i, j, k, a, b, c) - ax(i, j, k) * (f(i, j, k, a + 1, b, c) -
//                                                                                               f(i, j, k, a, b, c)) *
//                                                                                dt / hvx;
//                            }
//                        }
...
//                        for (size_t b = 1; b < nvy - 1; b++) {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                f(i, j, k, a, b, c) = ftime(i, j, k, a, b, c) - ay(i, j, k) * (ftime(i, j, k, a, b, c) -
//                                                                                               ftime(i, j, k, a, b - 1,
//                                                                                                     c)) * dt / hvy;
//                            }
//                        }
...
//                        for (size_t b = 1; b < nvy - 1; b++) {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                ftime(i, j, k, a, b, c) = f(i, j, k, a, b, c) - az(i, j, k) * (f(i, j, k, a, b, c) -
//                                                                                               f(i, j, k, a, b,
//                                                                                                 c - 1)) * dt / hvz;
//                            }
//                        }
...
//                        for (size_t b = 1; b < nvy - 1; b++) {
//                            for (size_t c = 1; c < nvz - 1; c++) {
//                                ftime(i, j, k, a, b, c) = f(i, j, k, a, b, c) - az(i, j, k) * (f(i, j, k, a, b, c + 1) -
//                                                                                               f(i, j, k, a, b, c)) *
//                                                                                dt / hvz;
//                            }
//                        }
...
//                    for (size_t b = 1; b < nvy - 1; b++) {
//                        for (size_t c = 1; c < nvz - 1; c++) {
//                            f(i, j, k, a, b, c) = ftime(i, j, k, a, b, c) + wc * (maxwellianDistribution(vx[a], vy[b],
//                                                                                                         vz[c]) *
//                                                                                  n(i, j, k) -
//                                                                                  ftime(i, j, k, a, b, c)) * dt;
//                        }
//                    }
//                }
//            }
